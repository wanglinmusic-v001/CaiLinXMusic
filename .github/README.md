...
- Get your [Necessary Variables](https://github.com/wanglinmusic-v001/CaiLinXMusic/blob/master/sample.env)
---
...
5. **Clone the Repository**
   ```bash
   git clone https://github.com/wanglinmusic-v001/CaiLinXMusic && cd CaiLinXMusic
   ```
